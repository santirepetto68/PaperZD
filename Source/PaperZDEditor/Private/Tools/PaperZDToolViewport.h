...
public:
    ...
    void Construct(const FArguments& InArgs, TSharedRef<class FPaperZDToolViewportClient> InViewportClient);
...
protected:
    ...
    TSharedPtr<class FPaperZDToolViewportClient> ViewportClient;
